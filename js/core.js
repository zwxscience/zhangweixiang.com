...
Core.menu={
    ...
    [{
        ...
        },
        {
             text: "我的Blog",
             func: function () {
                 var url = "http://blog.zhangweixiang.com/";
                 window.open(url);
             }
         },
         {
              text: "Github",
              func: function () {
                  var url = "https://github.com/zwxscience";
                  window.open(url);
         ...
         },
         {
              text: "我的微博",
              func: function () {
                  var url = "http://www.weibo.com/weixiazh";
                  window.open(url);
              }
         },
         {
              text: "我的豆瓣",
              func: function () {
                  var url = "http://www.douban.com/people/48750803/";
                  window.open(url);
              }
         },
         {
         ...
         },
         {
            text: "百度云",
            func: function() {
                var url = "http://pan.baidu.com/disk/home";
                window.open(url);
            }
        }]]
    },
    {
        ...
        [{
            ...
            data: [[{
                text: "木纹",
                func: function () {
                    $(this).attr("style", 'background:url(images/1.jpg) repeat right bottom transparent;');
                }
            }, {
                text: "云海",
                func: function () {
                    $(this).attr("style", 'background:url(images/2.jpg) repeat right bottom transparent;');
                }
            }, {
                text: "星空",
                func: function () {
                    $(this).attr("style", 'background:url(images/3.jpg) repeat right bottom transparent;');
                }
            }, {
                text: "萌娃",
                func: function () {
                    $(this).attr("style", 'background:url(images/4.jpg) repeat right bottom transparent;');
                }
            }]]
        }]
    ],
...
Core.handle = function(obj){
    ...
    //新窗口进入
    obj.find("#newwin").bind("click", function (e) {
